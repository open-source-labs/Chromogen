...
/******/ 	return __webpack_require__(__webpack_require__.s = "./extension/background.js");
/******/ })
/************************************************************************/
/******/ ({
...
chrome.runtime.onConnect.addListener(function (port) {
  var extensionListener = function extensionListener(message, sender, sendResponse) {
    var name = message.name,
        tabId = message.tabId; // store current instance of DevTools page
  ...
  port.onMessage.addListener(extensionListener); // handle disconnect

  port.onDisconnect.addListener(function (port) {
    port.onMessage.removeListener(extensionListener); // remove current instance from connections

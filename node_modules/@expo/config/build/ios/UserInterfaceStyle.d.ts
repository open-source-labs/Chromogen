...
export declare function getUserInterfaceStyle(config: ExpoConfig): any;
export declare function setUserInterfaceStyle(config: ExpoConfig, infoPlist: InfoPlist): InfoPlist | {
